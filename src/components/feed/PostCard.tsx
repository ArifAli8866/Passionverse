...
export default function PostCard({ post, onLike, onSave }: PostCardProps) {
  ...
  {post.type !== "text" && (
      ...
      <div className="flex items-center gap-4 px-5 py-2 border-t border-gray-50 dark:border-gray-800">
        ...
        <span className="text-xs text-gray-400">{formatCount(post.comments + comments.length)} comments</span>
        <span className="text-xs text-gray-400">{formatCount(post.shares)} shares</span>
      </div>
