...
const Button = forwardRef<HTMLButtonElement, ButtonProps>(
  ({ className, variant = "primary", size = "md", isLoading, children, disabled, ...props }, ref) => {
    ...
    const variants = {
      primary:
        "bg-gradient-to-r from-indigo-500 to-purple-600 text-white hover:from-indigo-600 hover:to-purple-700 shadow-lg shadow-indigo-200 dark:shadow-indigo-900/30 focus:ring-indigo-500",
      secondary:
      ...
      danger:
        "bg-red-500 text-white hover:bg-red-600 shadow-lg shadow-red-200 dark:shadow-red-900/30 focus:ring-red-500",
    };
